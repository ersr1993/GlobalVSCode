namespace myConsole{
    ...
    using System;
    using System.Linq;
    public abstract class Menu : IPage {
        ...
        {
            myConsole.MyConsole.SayAndWait("Here is some real nice function");
        }
        private void OtherFunc(){
            myConsole.MyConsole.SayAndWait("but you could have chosen nb 1");
        }
        public void DisplayMenu()
        {
            ConsoleKey choice;
            do{
                choice = MyConsole.DisplayPage(this);
                Execute(choice);}
