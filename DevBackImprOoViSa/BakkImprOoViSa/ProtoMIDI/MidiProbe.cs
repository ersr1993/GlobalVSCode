    ...
    unsafe sealed class MidiProbe : System.IDisposable
    {
        ...
        public MidiProbe()
        {
            ...
            if (_rtmidi == null || !_rtmidi->ok)
                ...
                throw new Exception("Failed to create an RtMidi device object.");
        }
        ...
        private bool WrapperIsOk(RtMidiDll.Wrapper* wrapper)
        {
            bool result;
            bool wrapperIsNull;
            bool wrapperIsOk;

            wrapperIsNull = wrapper == null;
            wrapperIsOk = wrapper->ok;

            result = wrapperIsNull || !wrapperIsOk;
